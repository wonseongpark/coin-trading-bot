...
def entry_signal(df):
    ...
    if rsi < 30: return True, 0
    elif rsi < 35: return True, 1
    return False, -1
...
def run_strategy_a(allocated_krw):
            ...
            try:
                ...
                if "uuid" in res:
                    record_entry(
                        ...
                        stop_loss=current_price * (1 + STRATEGY_A_STOP_LOSS),
                        take_profit_levels=[current_price * (1 + x) for x in STRATEGY_A_PROFIT_TARGETS],
